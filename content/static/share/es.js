export default `
  <p>
    ...
    <a href="">correo electrónico</a>. También puedes compartir esta página
    con tus amigos a través de <a href="https://twitter.com/intent/tweet?url=%URL%&text=%TITLE%&via=%TWITTER%" target='_blank'>Twitter</a>,
