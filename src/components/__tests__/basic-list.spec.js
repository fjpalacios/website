...
describe('BasicList', () => {
  ...
  it('should show the name', () => {
    ...
    const name = container.querySelectorAll('.basic-list__name span')[0].textContent
  ...
  it('should show a url if it exists', () => {
    ...
    const { container } = createComponentWithIntl(<BasicList data={data} />)
    const name = container.querySelectorAll('.basic-list__name a')[0].textContent
    expect(name).toBe(data[0].name)
  ...
  it('should show the location', () => {
    const { container } = createComponentWithIntl(<BasicList data={data} />)
    const location = container.querySelectorAll('.basic-list__location')[0].textContent
    expect(location).toBe(data[0].location)
  })

  it('should show the dates', () => {
    const { container } = createComponentWithIntl(<BasicList data={data} />)
    const dates = container.querySelectorAll('.basic-list__dates')[0].textContent
