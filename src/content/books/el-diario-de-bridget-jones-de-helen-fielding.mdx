...
import { BookInlineImage } from "@components/blog";
...
Por otro lado [Helen Fielding](/es/autores/helen-fielding/) dice que Bridget es filóloga; una filóloga que se ha sacado una carrera sin saber escribir, pero filóloga a fin de cuentas. La autora se supone que escribe libros, o lo que sea que haga con los pobres libros, así que una mínima idea del trabajo que se realiza en una editorial debería de tener. ¿Por qué lo único que se ve de Bridget en su trabajo dentro de una editorial son mensajes en plan ligoteo entre ella y su jefe? Podría hacer… ¿algo? Y cuando no está enviando o leyendo mensajes deja la oficina y se larga al bar con sus amigas porque han declarado «situación de emergencia». Pues muy bien.




<BookInlineImage src="/images/books/inline/LC-bridget-jones.jpg" alt="Lectura conjunta: El diario de Bridget Jones" />
