...
<BookLink title="El libro prohibido" /> es la segunda parte de la colección [Los misterios de
Setna](/es/series/los-misterios-de-setna/) escrita por <AuthorLink name="Christian Jacq" />.
...
La edición del libro sigue manteniendo las ilustraciones que ya tenía <BookLink title="La tumba maldita" />, el primer libro de la colección, al finalizar la mayoría de los capítulos. Y una referencia a todas ellas al finalizar el libro para que se pueda saber de dónde han sido extraídas.
