...
Esta antología se compone de ocho relatos: <BookLink title="Una edad difícil" />, _Vivos_, _La familia_, _La agencia_, _La grieta_, _Las reglas_, _La eternidad de Yasha_ y _Espero_. A continuación paso a comentar los que más me han gustado de forma detallada.
...
Este relato me ha recordado muchísimo a <BookLink title="La metamorfosis" /> (<AuthorLink name="Franz Kafka" />, 1915).
