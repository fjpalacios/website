  ...
  experience: [
    {
      ...
      desc: "Operational process automation with StackStorm and Dolphin (Python, Bash). PagerDuty API and MQTT integration for reactive incident response. Rigorous unit testing, comprehensive documentation and standards definition in production.",
    ...
    },
    {
      ...
      desc: "Backends in Typescript (Nest.js) and Python (FastAPI) with REST/OpenAPI. MongoDB and ElasticSearch for high-traffic projects. Development in PHP (Laravel 11) and React. Created Kafka producers and consumers to connect 11 microservices.",
    ...
    },
    {
      ...
      desc: "Automation tools (Python, Bash) and orchestration (Concourse, GitHub Actions). <em>Dockerisation</em> of projects and code standardisation with thorough testing. Centralised log viewer (Promtail, Loki, Grafana). Linux machine management with SaltStack and Terraform.",
