  ...
  experience: [
    {
      ...
      desc: "Automatización de procesos operativos con StackStorm y Dolphin (Python, Bash). Integración con PagerDuty API y MQTT para respuesta reactiva ante incidencias. Testing unitario riguroso, documentación exhaustiva y definición de estándares en producción.",
    ...
    },
    {
      ...
      desc: "Backends en Typescript (Nest.js) y Python (FastAPI) con REST/OpenAPI. MongoDB y ElasticSearch para alto tráfico. Desarrollo en PHP (Laravel 11) y React. Creación de productores y consumidores de Kafka para conectar 11 microservicios.",
    ...
    },
    {
      ...
      desc: "Herramientas de automatización (Python, Bash) y orquestación (Concourse, GitHub Actions). <em>Dockerización</em> de proyectos y estandarización de código con testing exhaustivo. Visualizador de logs centralizado (Promtail, Loki, Grafana). Gestión de máquinas Linux con SaltStack y Terraform.",
