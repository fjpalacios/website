...
En el artículo [Cómo recuperar ficheros tras modificarlos gracias a Git](/es/tutoriales/como-recuperar-ficheros-git/) ya vimos qué hacer en algunos casos en los que hemos metido la pata modificando un archivo de forma errónea. ¿Pero qué podemos hacer cuando ya hemos hecho _commit_ a aquello que está incorrecto? Aquí trataremos de explicártelo.
