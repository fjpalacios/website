...
Like we already explained in our first article for this course [What is Git?](/en/article/what-is-git/): Git is a decentralized service, you won't find the typical _client-server_ kind of structure but with **remotes** we can emulate this method to which all of us are so used to.
