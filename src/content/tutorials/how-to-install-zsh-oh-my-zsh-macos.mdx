...
```
From this moment all the configuration of both *zsh* and *Oh My ZSH!* will be in a `~/.zshrc` file that will be automatically generated, from which you can [change your prompt theme](https://github.com/robbyrussell/oh-my-zsh/wiki/Themes), [add Oh My ZSH! plugins](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins), and so on.
