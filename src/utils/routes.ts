...
export function buildShelfUrl(lang: string): string {
  return buildLocalizedPath(lang, "books", "shelf");
}

export function buildStatsUrl(lang: string): string {
  return buildLocalizedPath(lang, "books", "stats");
}
